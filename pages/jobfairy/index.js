...
import { WorkTitle, WorkIntro, WorkTags, WorkFull } from '../../components/work'
        ...
        <article>
          ...
          <section className="work">
            ...
            <WorkFull 
              ...
              text="This solution primarily targets university students who are more or less looking for their first job, internship or summer employment. This data comes from sitting down with both groups and talking about recruitment events and what they consider are the positives, negatives and what can be improved in the overall experience."
            />

            <WorkFull 
              image="research.png" 
              alt="Thought process and needs"
              caption="A comparison of the two user groups that the solution is targeting. Here are their wants and in the third column, we can see their overlapping needs."
            />

            <WorkFull 
              subtitle="User Research"
              text="We also learn key information that validates our hypothesis, that recruitment events are old fashioned and it is difficult to stand out as an individual in a sea of individuals. The primary frustration on the part of the applicants seems to be the lack of transparency with regards to the process that HR departments have when they are processing CVs. Students are left in the dark for weeks and sometimes months a time which prevents them from being able to make employment decisions on their own terms. "
            />
            ...
            <WorkFull 
              image="wireframe.png"
              alt="jobfairy initial wireframe"
            />
